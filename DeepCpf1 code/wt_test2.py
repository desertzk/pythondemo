        ...
        for dict_struct in struct_list:
            for layer_type, dict_params in dict_struct.items():
                ...
                if layer_type == "conv":
                    ...
                    layers["sub"+str(idx)] = layer_model
                    layers1.append(layer_model)
                    ...
                    layers["add"+str(idx)] = layer_model
                    layers1.append(layer_model)
                    ...
                    layers["concat"+str(idx)] = layer_model
                    layers1.append(layer_model)
                    last_out = d_model
