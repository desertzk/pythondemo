...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("debugpadding.log"),
...
class PolicyGradientNetwork(nn.Module):
    ...
    def __init__(self,state,architecture_map=None,hidden_size=64):
        super().__init__()
...
class PolicyGradientAgent():
    ...
    def __init__(self):
        ...
        self.conv1d_out_channels_list = [i for i in range(500) if i>9 and i%5==0] #[80,90,100,110]
        self.conv1d_kernel_size_list = [1,3,5,7,9]  #[7,5,1]
        self.drop_out_list = [0,0.05,0.1,0.15,0.2,0.25,0.3]
        self.conv_num_list = [1,2,3,4,5,6,7]
