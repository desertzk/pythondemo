...
class PolicyGradientNetwork(nn.Module):
    ...
    def __init__(self,state,architecture_map=None,hidden_size=64,max_layer=6):
        ...
        self.conv_layer =  nn.Linear(state_size, len(architecture_map["conv_num"]))
        self.linear_layer =  nn.Linear(state_size, len(architecture_map["linear_num"]))
