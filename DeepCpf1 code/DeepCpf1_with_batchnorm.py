...
class Regression(nn.Module):
    def __init__(self):
        ...
        self.batchnorm80 = nn.BatchNorm1d(80)
        self.linear80_40 = nn.Linear(80, 40)  #(None, 40)
        self.batchnorm40 = nn.BatchNorm1d(40)
    ...
    def forward(self, x):
        ...
        outconv1d = self.batchnorm(outconv1d)
        ...
        # out_dropout = self.batchnorm(out_flatten)
        # Seq_deepCpf1_DO1 = Dropout(0.3)(Seq_deepCpf1_F)
        out_linear1200_80 = self.linear1200_80(out_flatten)
        # bn80 = self.batchnorm80(out_linear1200_80)
        out_act_linear1200_80 = self.relu(out_linear1200_80)
        # out_dropout80_40 = self.dropout(out_act_linear1200_80)
        out_linear80_40 = self.linear80_40(out_act_linear1200_80)
        out_dropout40 = self.batchnorm40(out_linear80_40)
        out_act80_40 = self.relu(out_dropout40)
        # Seq_deepCpf1_D2 = Dense(40, activation='relu')(Seq_deepCpf1_DO2)

        # Seq_deepCpf1_DO3 = Dropout(0.3)(Seq_deepCpf1_D2)
        out_linear40_40 = self.linear40_40(out_act80_40)
        # out_linear40_40 = self.batchnorm40(out_linear40_40)
        out_act40_40 = self.relu(out_linear40_40)
        # out_dropout40_40 = self.dropout(out_act40_40)
        # Seq_deepCpf1_D3 = Dense(40, activation='relu')(Seq_deepCpf1_DO3)

        # Seq_deepCpf1_DO4 = Dropout(0.3)(Seq_deepCpf1_D3)
        out = self.linear40_1(out_act40_40)
